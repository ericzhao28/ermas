...
def get_args():
    ...
    parser.add_argument('--main_episodes', type=int, default=5)
    parser.add_argument('--num_loops', type=int, default=10)

    # ERMAS Params
    parser.add_argument('--lambda_lr', type=float, default=20)
    parser.add_argument('--beta', type=float, default=0.3)
    parser.add_argument('--ermas_eps', type=float, default=0.1)
    parser.add_argument('--eval_episodes', type=int, default=2)
    parser.add_argument('--unilateral_episodes', type=int, default=3)
